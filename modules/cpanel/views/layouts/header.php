<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <a href="/"><img src="/img/logo_old.png" height="52px" alt="SmartAdmin"></a> </span>
        ...
        <div id="logout" class="btn-header transparent pull-right">
            <span>
                <?= \yii\helpers\Html::a(
                    ...
                    ['/cpanel/default/logout'],
                    ['data-method' => 'post', 'class' => 'btn btn-default btn-flat',
                    'data-logout-msg' => Yii::t('app', 'Sign out'),
                    'title' => Yii::t('app', 'Sign out'),
                    //'data-action' => 'userLogout'
                    ]
                ) ?>
                <!--<a href="login.h" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> -->
            </span>
        </div>
        <!-- end logout button -->
