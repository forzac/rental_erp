...
use app\extensions\smartadmin\widgets\RadioWidget;
...
<section id="widget-grid" class="">
    ...
    <div class="row-margin row">
        ...
        <?= Html::a('<i class="fa fa-plus"></i> '. \Yii::t('app','Add'), Url::to(['agent/create']) , ['class' => 'btn btn-success pull-right']); ?>
        </div>
    </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value'=>function ($model) {
                            return  \app\models\Agent::getTypes()[$model->agent_type];
                        },
                    ],
